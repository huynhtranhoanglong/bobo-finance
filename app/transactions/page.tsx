...
import TransactionItem from "@/components/cards/transaction-item";
            ...
            <PullToRefresh>
                <main className="relative isolate min-h-screen bg-[#FAFAFA] overflow-hidden">
                    ...
                    <div className="max-w-2xl mx-auto p-4 md:p-8 pb-32">
                        {/* Header */}
                        <PageHeader title={t.LABEL_TRANSACTION_HISTORY} user={user} className="px-0 pt-0" showBackButton={false} />

-- ============================================================
-- FIX NET WORTH CALCULATION (v1.3.12)
-- Date: 2026-01-16
-- Purpose: Add receivable debts (money others owe you) to Net Worth
-- Formula: Net Worth = Total Assets - Payable Debts + Receivable Debts
-- ============================================================
...
BEGIN
    ...
    -- Calculate Payable Debts (money you owe others)
    ...
    -- NEW: Calculate Receivable Debts (money others owe you)

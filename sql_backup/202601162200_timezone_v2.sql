-- ============================================================
-- TIMEZONE LOCALIZATION V2 (v1.3.13)
-- Date: 2026-01-16
-- Purpose: Update get_dashboard_data to accept user's timezone
-- Using Cookie-based approach for Server Component compatibility
-- ============================================================
...
-- Recreate with timezone parameter (has default for backward compatibility)
